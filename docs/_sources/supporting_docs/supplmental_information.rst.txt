...
.. figure:: ../_static/cumulative_n_records_per_source.png
   ...
   Cumulative number of records per source.

.. figure:: ../_static/cumulative_n_sites_per_source.png
    :align: center

    Cumulative number of sites per source.
...
.. figure:: ../_static/cdf_depth_to_water_depth_cat_1.png
   ...
   Cumulative probability of depth to water for depth category 1 (shallow wells).
