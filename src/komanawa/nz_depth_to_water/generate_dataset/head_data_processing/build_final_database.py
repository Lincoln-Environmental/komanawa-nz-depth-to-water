...
try:
    ...
    from komanawa.nz_depth_to_water.dummy_packages import get_best_elv

from komanawa.nz_depth_to_water.generate_dataset.head_data_processing import get_bop_data, get_auk_data, get_ecan_data, \
...
from komanawa.nz_depth_to_water.generate_dataset.head_data_processing import data_processing_functions
from komanawa.nz_depth_to_water.generate_dataset.project_base import project_dir, groundwater_data
