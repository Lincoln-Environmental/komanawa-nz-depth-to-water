...
from komanawa.nz_depth_to_water.update_technial_note.data_stats import get_data_stats, write_rst_table_with_tabulate, \
    get_running_totals
from komanawa.nz_depth_to_water.update_technial_note.statistical_measures_of_dwt_data import hist_sd, exceedance_prob

docs_build_dir = Path(__file__).parents[4].joinpath('docs_build')
...
if __name__ == '__main__':
    ...
    update_tech_note(wd, md, unbacked_dir)
